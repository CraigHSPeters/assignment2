...
function as_settings_link_lbs($links) {
    ...
    $as_settings_link2= '<a href="edit.php?post_type=lightbox-slider">Settings</a>';
...
// Review Box Notice
add_action("admin_notices", "review_admin_notice_lbs");
function review_admin_notice_lbs(){
    $screen = get_current_screen();
    if($screen->post_type == "lightbox-slider"){
        echo '<div class="notice notice-success is-dismissible review-notice">
		<p>Thanks for installing and using LIGHT BOX Slider plugin. If you love our plugin and plugin is really work for you.
		Then please share your feedback about this plugin. Your feedback will be helpful to make plugin more error free.</p>
		<p><a href="https://wordpress.org/support/plugin/lightbox-slider/reviews/?filter=5" target="_blank" name="review" id="review" class="button button-primary">Review & Rate</a></p>
		</div>';
    }
	//ADMIN NOTICE
	?>
